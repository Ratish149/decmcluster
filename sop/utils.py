...
def send_sop_verification_email(instance, comment=None):
    """
    Utility function to send a verification request email for a SOP instance to the admin.
    """
    ...
    if instance.description:
        details.append({"label": "Description", "value": instance.description})
    if file_url:
    ...
    if not base_url.endswith("/"):
        base_url += "/"
    admin_url = f"{base_url}sops/verify/{instance.id}/"
