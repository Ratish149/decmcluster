...
def send_report_verification_email(instance, comment=None):
    """
    Utility function to send a verification request email for a Report instance to the admin.
    """
    ...
    details = [
        ...
        {"label": "Type", "value": instance.type or "N/A"},
    ...
    if not base_url.endswith("/"):
        base_url += "/"
    admin_url = f"{base_url}situational-reports/verify/{instance.id}/"
