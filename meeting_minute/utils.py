...
def send_meeting_minute_verification_email(instance, comment=None):
    """
    Utility function to send a verification request email for a MeetingMinute instance to the admin.
    """
    ...
    if not base_url.endswith("/"):
        base_url += "/"
    admin_url = f"{base_url}meeting-minute/verify/{instance.id}/"
